...
export default function GenericSection({ variant, content }: GenericProps) {
  ...
  switch (category) {
    ...
    case "services":     return <ProductsSection content={content} vn={vn} />;
    case "advantages":   return <AdvantagesSection content={content} vn={vn} />;
    case "showcase":     return <GallerySection content={content} vn={vn} />;
    ...
    case "blog":         return <ProductsSection content={content} vn={vn} />;
